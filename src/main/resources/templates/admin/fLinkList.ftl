                                ...
                                <div class="widget-main no-padding">
                                    <table class="table table-bordered table-striped">
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <button class="btn btn-xs btn-primary" onclick="window.location.href='edit?id=${fLink.id}'">
                                            ...
                                            <td>
                                                <button class="btn btn-xs btn-danger" name="${fLink.id}">
...
<script type="text/javascript">
    ...
    jQuery(function($) {
        $(".btn-danger").click(function(){
            var sid=$(this).attr("name");//点击获取当前button的id值
            warn('warn!','确认删除!','f',true,'确认',function(){
                $.ajax({
                    url:"http://127.0.0.1:8088/admin/f_link/delete",
                    type:'POST',
                    dataType:'json',
                    data:{
                        id: sid,
